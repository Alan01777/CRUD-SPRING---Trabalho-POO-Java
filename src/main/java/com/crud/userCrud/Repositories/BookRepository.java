...
public interface BookRepository extends JpaRepository<Book, Long> {
    ...
    //BookRepository é uma interface que estende JpaRepository, que é fornecida pelo Spring Data JPA. 
    //Essa interface fornece métodos de acesso aos dados do tipo Book no banco de dados.
    ...
    //O Spring Data JPA implementa esses métodos automaticamente com base nas convenções 
